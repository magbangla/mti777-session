...
class KangalouSpider(scrapy.Spider):
	...
	custom_settings = {
		'DOWNLOADER_MIDDLEWARES': {'mti777.middlewares.Mti777DownloaderMiddleware': 543},
		'ITEM_PIPELINES':{'mti777.pipelines.Mti777Pipeline': 300}
	}
	def parse(self, response):
		...
		for annonce in annonces:
			...
			img_small="https://www.kangalou.com"+str(annonce.xpath('//*[@id="search-view"]/div/aside/div[3]/div[3]/article[1]/div[1]/figure/div[3]').xpath("@data-background-image").extract_first())
			print(img_small)
